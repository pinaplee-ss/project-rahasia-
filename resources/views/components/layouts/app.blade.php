...
{{ $slot }}
        <div class="py-6 px-6 text-center">
          {{-- <p class="mb-0 fs-4"> <a href="" target="_blank" class="pe-1 text-primary text-decoration-underline">AdminMart.com</a> Distributed by <a href="https://themewagon.com">ThemeWagon</a></p> --}}
        </div>
      </div>
    </div>
  </div>
